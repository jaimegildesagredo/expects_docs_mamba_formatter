...
from mamba import settings, formatters, reporter, runners, example_collector, loader, expects_docs_formatter
...
class ApplicationFactory(object):
    ...
    def create_formatter(self):
        ...
        if settings.format == 'expects_docs':
            return expects_docs_formatter.ExpectsDocsFormatter(settings)
